...
func CreateMetricsService(ctx context.Context, cfg *rest.Config, servicePorts []v1.ServicePort) (*v1.Service, error) {
	...
	_, err = util.CreateOrUpdate(ctx, forService(clientSet, s.Namespace), s, func(existing runtime.Object) (runtime.Object, error) {
...
func forService(client kubernetes.Interface, namespace string) resource.Interface {
	return &resource.InterfaceFuncs{
		...
		CreateFunc: func(ctx context.Context, obj runtime.Object, options metav1.CreateOptions) (runtime.Object, error) {
			return client.CoreV1().Services(namespace).Create(ctx, obj.(*v1.Service), options)
		},
		UpdateFunc: func(ctx context.Context, obj runtime.Object, options metav1.UpdateOptions) (runtime.Object, error) {
			return client.CoreV1().Services(namespace).Update(ctx, obj.(*v1.Service), options)
		},
